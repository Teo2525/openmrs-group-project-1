...
import java.util.List;
    ...
    public class HomePage  {
        ...
        private void verifyGeneralTabs() {
            List<WebElement> tabs = driver.findElements(By.xpath("//ul[@class='navbar-nav ml-auto user-options']/li"));
            String[] tabNames = {"admin", "Impatient Ward", "Logout"};
            int i = 0;
            for (String tab : tabNames) {
                softAssert.assertEquals(tab.trim(), tabNames[i],"match");
                i++;
            }
        }
        ...
        public void topElements() {
            ...
            softAssert.assertTrue(selectedImpatientWard.isDisplayed());
